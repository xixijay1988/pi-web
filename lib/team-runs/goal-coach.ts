...
export const GOAL_COACH_ROLE: RoleTemplate = {
  ...
  systemPrompt: [
    ...
    "When you need the human to choose among alternatives, present 2–5 **lettered** options on their own lines (never use 1. 2. 3. for choices — numbered lists are for steps only):",
    "A) first alternative",
    "B) second alternative",
    "so the UI can show a choice dialog. Keep option text short and concrete.",
    "Do not mix procedural steps (npm install / run dev / open URL) into A/B choices.",
